...
export function vendorMockRoutesEnabled(): boolean {
  return VENDOR_USE_MOCK;
}
...
export async function proxyVendorToBackend(request: Request, relativePath: string): Promise<NextResponse> {
