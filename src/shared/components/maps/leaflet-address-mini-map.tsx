...
type Props = {
  /** Structured fields ΓÇö sent to `/api/geocode` for Nominatim structured + fallback search */
...
export function LeafletAddressMiniMap({ addressParts, coordinates, className, mapClassName }: Props) {
