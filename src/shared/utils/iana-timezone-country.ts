/**
 * Canonical IANA time zone → ISO 3166-1 alpha-2 (primary country).
 * Used to default phone calling codes to where the device is set.
 */
const COUNTRY_ZONES: Record<string, readonly string[]> = {
  ...
  GH: ["Africa/Accra"],
  GI: ["Europe/Gibraltar"],
  GL: ["America/Danmarkshavn", "America/Nuuk", "America/Scoresbysund", "America/Thule", "America/Godthab"],
  GM: ["Africa/Banjul"],
  GN: ["Africa/Conakry"],
...
export function countryIsoFromIanaTimeZone(timeZone: string | null | undefined): string | undefined {
