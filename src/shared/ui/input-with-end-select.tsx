...
const frameClassName = cn(
  "flex min-h-[var(--form-control-height,2.5rem)] h-[var(--form-control-height,2.5rem)] w-full min-w-0 items-center overflow-hidden rounded-xl border border-slate-200 bg-white text-[length:var(--dash-body-size,0.875rem)] shadow-sm transition",
